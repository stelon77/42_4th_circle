...
/*   Updated: 2021/01/14 09:27:14 by lcoiffie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::cout << "\n-------SUPER TRAP----------\n\n" << std::endl;
	...
	SuperTrap super("Wonderboy");

	super.meleeAttack("bad boy");
	super.rangedAttack("superman");
	super.takeDamage(45);
	super.beRepaired(25);
	super.vaulthunter_dot_exe("magneto");
